...
  useEffect(() => {
    // FIX: Only access 'document' if we are in the client environment (browser).
    // This prevents the Next.js build (which runs in Node.js on Vercel) from crashing.
    if (typeof window !== "undefined") {
      document.cookie = "et3aa_auth=; path=/; max-age=0; expires=Thu, 01 Jan 1970 00:00:00 GMT"
    }

    // Also call logout API to clear server-side (and often sets the clearing cookie header)
